...
def initializeButtons(app):
    ...
    app.restartInGame = Button(app.width/5, app.height/12+20, 50, 'Restart', 'rect')
    app.startGame = Button(app.width/2, app.height/2+200, 50, 'Start', 'rect')
    app.invisPowerup = Button(app.width/3+25, 50, 15, '', 'circle')
    app.wallPowerup = Button(app.width/3+25, 90, 15, '', 'circle')
    app.openSpinner = Button(app.width/3+25, 130, 15, '', 'circle')